const COPY = Object.freeze({
  en: Object.freeze({
    ...
    shared: 'Shared',
    copied: 'Copied',
    shareSuccess: 'Receipt shared.',
    copySuccess: 'Receipt copied.',
    ...
    invalidUrl: 'Receipt link is unavailable.',
    shareTitle: 'Creatorverse completion receipt',
  ...
  ar: Object.freeze({
    ...
    shared: 'تمت المشاركة',
    copied: 'تم النسخ',
    shareSuccess: 'تمت مشاركة الإيصال.',
    copySuccess: 'تم نسخ الإيصال.',
    ...
    invalidUrl: 'رابط الإيصال غير متاح.',
    shareTitle: 'إيصال إنجاز Creatorverse',
